        ...
        <div className="flex items-center w-full my-4">
            ...
            <div className="my-6 space-y-2">
                ...
                <button aria-label="Login with GitHub" role="button"
                    className="flex items-center justify-center w-full p-2 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-indigo-500" onClick={handleGithubSignIn}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                        <path
